...
const comment_routes_1 = __importDefault(require("./routes/comment.routes")); // Import the comment routes
...
app.use('/api/comments', comment_routes_1.default); // Use the comment routes
